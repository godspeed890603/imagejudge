...
#             #########################################################################################
            ...
            ret = []
            ret.append(np.array(batch_X[i]))
            print(type(ret[0]))
            print("test1")
            cv2.imshow("testimg", ret[0])
            cv2.imwrite("D:/temp/cv/ssd_keras-master/datasets/udacity_driving_datasets/1.jpg",np.array(batch_X[i]))
#             k=k+1
